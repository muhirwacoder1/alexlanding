                  ...
                  {BlogContent ? (
                    ...
                    <div className="py-8">
                      <h2 className="text-2xl font-bold text-gray-900 mb-4">
                        {blogData?.title || 'Article Content'}
                      </h2>
                      <p className="text-gray-600 mb-6">
                        {blogData?.excerpt || 'Loading article content...'}
                      </p>
                      
                      {/* Fallback content */}
                      <div className="space-y-6">
                        <h3 className="text-xl font-semibold text-gray-800">Article Overview</h3>
                        <p className="text-gray-700 leading-relaxed">
                          This article explores the latest developments in healthcare technology and innovation. 
                          Our team is dedicated to bringing you insights into how technology is transforming 
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-gray-700">
                          ...
                          <li>Improving patient outcomes through smart solutions</li>
                          <li>The future of preventive healthcare</li>
                          <li>Real-world applications and benefits</li>
                        </ul>
                        
                        <h3 className="text-xl font-semibold text-gray-800">Our Mission</h3>
                        <p className="text-gray-700 leading-relaxed">
                          At NEEM, we're committed to revolutionizing healthcare through innovative technology solutions. 
                          Our smart insole technology represents a breakthrough in preventive care, helping patients 
                          avoid serious complications before they occur.
                        </p>
                        
                        <h3 className="text-xl font-semibold text-gray-800">The Technology</h3>
                        <p className="text-gray-700 leading-relaxed">
                          Our smart insoles use advanced sensors to monitor foot pressure, temperature, and other 
                          vital indicators. This real-time data helps detect early signs of potential complications, 
                          allowing for immediate intervention and prevention of serious health issues.
                        </p>
                        
                        <h3 className="text-xl font-semibold text-gray-800">Impact</h3>
                        <p className="text-gray-700 leading-relaxed">
                          Studies have shown that early detection and intervention can reduce the risk of diabetic 
                          foot complications by up to 90%. Our technology is making this level of prevention 
                          accessible to patients worldwide.
                        </p>
                        
                        <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200">
                          <h4 className="text-lg font-semibold text-blue-900 mb-2">Learn More</h4>
                          <p className="text-blue-800 text-sm">
                            Interested in learning more about our technology? Contact our team to discover 
                            how NEEM's smart insoles can make a difference in preventive healthcare.
                          </p>
                        </div>
                      </div>
                    </div>
